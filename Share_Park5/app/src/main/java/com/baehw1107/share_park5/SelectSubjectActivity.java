...
import static com.baehw1107.share_park5.R.id.result;

/**
 * Created by baehw_000 on 2017-06-07.
 */
...
public class SelectSubjectActivity extends AppCompatActivity{
    ...
    Button lsearchbtn;
    String s_am_pm1, s_am_pm2, s_time_gap1, s_time_gap2, address, post_start, post_end;
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = intent2.getStringExtra("post_result");
        ...
        post_start = new String(s_am_pm1 + s_time_gap1);
        post_end = new String(s_am_pm2 + s_time_gap2);
