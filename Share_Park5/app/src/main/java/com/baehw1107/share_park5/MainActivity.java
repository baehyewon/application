...
import static com.baehw1107.share_park5.R.id.search;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent it = getIntent();
        address = it.getStringExtra("post_result");
        ...
        all = new String(address + "\n" + "시작시간: " + p_am_pm1 + p_time_gap1 + "\n" + "종료시간: " + p_am_pm2 + p_time_gap2);
        start_time = new String(p_am_pm1+p_time_gap1);
        end_time = new String(p_am_pm2+p_time_gap2);
